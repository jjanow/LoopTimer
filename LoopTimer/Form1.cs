...
namespace LoopTimer
{
    ...
    {
        public long seconds = 0; // Seconds.
        public long minutes = 0; // Minutes.
        public long hours = 0;   // Hours.
        ...
        public Form1()
        {
            ...
            InitializeComponent();
            tbSeconds.KeyPress += new KeyPressEventHandler(tbSeconds_KeyDown);
            tbMinutes.KeyPress += new KeyPressEventHandler(tbMinutes_KeyDown);
            tbHours.KeyPress += new KeyPressEventHandler(tbHours_KeyDown);
        }
